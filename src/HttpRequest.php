...
class HttpRequest
{
    ...
    /**
     * @var int Request timeout, default 10 seconds
     */
    public $timeout;
    /**
     ...
     *
     * @param integer $key   The name of the cookie
     * @return self
     */
     ...
     * @param bool $act set ssl cert is verify
     * @return self
     */
    public function setSSLVerify($url, $act = false) {
        if(strlen($url) > 5 && strtolower(substr($url,0,5)) == "https" )
        {
            $this->setOpt(CURLOPT_SSL_VERIFYPEER, $act);
            $this->setOpt(CURLOPT_SSL_VERIFYHOST, $act);
        }
        return $this;
    }
    /**
    ...
    public function setOpt($option, $value)
    {
        ...
        {
            $this->requset_uri = $value;
            $this->setSSLVerify($value);//set is not verify https cert;
        }
